...
以前你要拿方格紙一格一格手繪地圖（沒錯，當年真的有人這樣做）。現在，在第一人稱迷宮裡隨時按一下 **`TAB`**——整張迷宮攤在你眼前：你走過的每一道牆、每一扇門、你此刻站在哪（白格），還有**黃點標出寶物、紅點標出怪物**。哪裡有埋伏、哪裡還沒探索、那把過關必備的鑰匙落在哪個房間，一目了然。
...
**還在路上**：怪物圖鑑補上吸血鬼弗拉迪米爾的 sprite、地圖加玩家朝向指北針與探索迷霧。
